package P2201_2300.P2300_Successful_Pairs_of_Spells_and_Potions;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        long success1 = 7;
        System.out.println(Arrays.toString(solution.successfulPairs(spells1, potions1, success1))); // [4, 0, 3]

        int[] spells2 = {3, 1, 2};
        int[] potions2 = {8, 5, 8};
        long success2 = 16;
        System.out.println(Arrays.toString(solution.successfulPairs(spells2, potions2, success2))); // [2, 0, 2]
    }
    ...
    public int[] successfulPairs(int[] spells, int[] potions, long success) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            res[i] = m - idx; // number of successful potions
        }
