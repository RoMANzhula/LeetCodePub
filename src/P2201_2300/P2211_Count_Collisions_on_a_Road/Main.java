package P2201_2300.P2211_Count_Collisions_on_a_Road;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.countCollisions("RLRSLL")); // output: 5
    }
    ...
    public int countCollisions(String directions) {
        ...
        // skip all leading 'L' cars that will never collide
        while (left < n && directions.charAt(left) == 'L') {
            left++;
        }

        // skip all trailing 'R' cars that will never collide
        ...
        // count all moving cars (L or R) inside the collision zone
