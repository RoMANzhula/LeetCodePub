package P2201_2300.P2221_Find_Triangular_of_an_Array;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] nums2 = {5};
        System.out.println(solution.triangularSum(nums2)); // Output: 5

        int[] nums3 = {9, 1, 2, 3};
        System.out.println(solution.triangularSum(nums3)); // Output: 1
    }
