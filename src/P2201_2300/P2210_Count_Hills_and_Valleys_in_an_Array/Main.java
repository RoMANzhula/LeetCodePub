package P2201_2300.P2210_Count_Hills_and_Valleys_in_an_Array;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.countHillValley(new int[]{2, 4, 1, 1, 6, 5})); // Output: 3
        System.out.println(solution.countHillValley(new int[]{6, 6, 5, 5, 4, 1})); // Output: 0
    }
    ...
    public int countHillValley(int[] nums) {
        ...
        for (int i = 1; i < len - 1; i++) {
            ...
            // find the next different number on the right
            int j = i + 1;
...
// non-equal neighbors of i are larger than nums[i]. Adjacent indices i and j are part of the same hill or
