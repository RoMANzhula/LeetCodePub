package P2001_2100.P2091_Removing_Minimum_and_Maximum_From_Array;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.minimumDeletions(nums1)); // 5

        int[] nums2 = {0, -4, 19, 1, 8, -2, -3, 5};
        System.out.println(solution.minimumDeletions(nums2)); // 3

        int[] nums3 = {101};
        System.out.println(solution.minimumDeletions(nums3)); // 1
    }
    ...
    public int minimumDeletions(int[] nums) {
        ...
        // make min index the smaller index
