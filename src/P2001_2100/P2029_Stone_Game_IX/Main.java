package P2001_2100.P2029_Stone_Game_IX;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.stoneGameIXX(new int[]{2, 1}));             // true
        System.out.println(solution.stoneGameIXX(new int[]{2}));                // false
        System.out.println(solution.stoneGameIXX(new int[]{5, 1, 2, 4, 3}));    // false
    }

    public boolean stoneGameIXX(int[] stones) {
        int count0 = 0;
        int count1 = 0;
        int count2 = 0;
