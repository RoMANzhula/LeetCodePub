package P2001_2100.P2043_Simple_Bank_System;

public class Main {

    public static void main(String[] args) {
        Main solution = new Main(new long[]{10, 100, 20, 50, 30});

        System.out.println(solution.withdraw(3, 10));   // true
        System.out.println(solution.transfer(5, 1, 20)); // true
        System.out.println(solution.deposit(5, 20));     // true
        System.out.println(solution.transfer(3, 4, 15)); // false
        System.out.println(solution.withdraw(10, 50));   // false
    }

    private long[] balance;

    public Main(long[] balance) {
...
// transactions (transfer, deposit, and withdraw). The bank has n accounts numbered from 1 to n. The initial
// balance of each account is stored in a 0-indexed integer array balance, with the (i + 1)th account having an
...
//boolean withdraw(int account, long money) Withdraw money dollars from the account numbered account. Return true if
