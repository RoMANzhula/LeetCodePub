package P801_900.P868_Binary_Gap;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.binaryGap(22)); // 2
        System.out.println(solution.binaryGap(8));  // 0
        System.out.println(solution.binaryGap(5));  // 2
    }
