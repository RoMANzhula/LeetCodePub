package P801_900.P837_New_21_Game;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.new21Game(10, 1, 10));  // 1.00000
        System.out.println(solution.new21Game(6, 1, 10));   // 0.60000
        System.out.println(solution.new21Game(21, 17, 10)); // ~0.73278
    }
    ...
    public double new21Game(int n, int k, int maxPts) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            if (i < k) {
                ...
                result += dp[i];  // valid stopping score
            }
