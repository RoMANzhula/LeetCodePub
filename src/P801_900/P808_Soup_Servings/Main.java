package P801_900.P808_Soup_Servings;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.soupServings(50));   // 0.62500
        System.out.println(solution.soupServings(100));  // 0.71875
    }

    private final Map<String, Double> memo = new HashMap<>();

    public double soupServings(int n) {
        if (n >= 4800) return 1.0; // cutoff for large n
        int units = (n + 24) / 25; // convert to units of 25mL
...
//If we perform the second serving operations, A will become empty on performing operation [1, 2, 3], and
// both A and B become empty on performing operation 4.
