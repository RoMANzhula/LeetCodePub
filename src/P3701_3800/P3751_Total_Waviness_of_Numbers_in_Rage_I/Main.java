package P3701_3800.P3751_Total_Waviness_of_Numbers_in_Rage_I;
...
public class Main {
    ...
    private int solve(int n) {
        ...
        memo = new Result[digits.length()][2][2][11][11];
    ...
    private Result dfs(
        ...
        return memo[pos][tight][started][prev1][prev2] =
                new Result(totalCount, totalWaviness);
    }
