package P1601_1700.P1622_Fancy_Sequence;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.getIndex(0)); // 10

        solution.addAll(3);
        solution.append(10);
        solution.multAll(2);

        System.out.println(solution.getIndex(0)); // 26
        System.out.println(solution.getIndex(1)); // 34
        System.out.println(solution.getIndex(2)); // 20
    }
