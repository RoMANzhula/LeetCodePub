package P1901_2000.P1917_Last_Day_Where_You_Can_Still_Cross;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.latestDayToCross(row1, col1, cells1)); // 2

        int row2 = 2, col2 = 2;
        int[][] cells2 = {{1,1},{1,2},{2,1},{2,2}};
        System.out.println(solution.latestDayToCross(row2, col2, cells2)); // 1
        ...
        System.out.println(solution.latestDayToCross(row3, col3, cells3)); // 3
    }
...
// given a 1-based 2D array cells, where cells[i] = [ri, ci] represents that on the ith day, the cell on the rith row
...
// cells. You can start from any cell in the top row and end at any cell in the bottom row. You can only travel in
