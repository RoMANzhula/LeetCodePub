package P3301_3400.P3314_Construct_the_Minimum_Bitwise_Array_I;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(solution.minBitwiseArray(nums1))); // [-1, 1, 4, 3]
        System.out.println(Arrays.toString(solution.minBitwiseArray(nums2))); // [9, 12, 15]
    }
