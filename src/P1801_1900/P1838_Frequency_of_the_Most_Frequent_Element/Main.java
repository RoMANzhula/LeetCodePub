package P1801_1900.P1838_Frequency_of_the_Most_Frequent_Element;
...
//У розв'язку задачі використовується алгоритм змінного вікна (sliding window),
// який допомагає знаходити оптимальний спосіб виконання операцій.
