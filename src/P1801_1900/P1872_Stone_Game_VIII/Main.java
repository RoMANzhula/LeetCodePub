package P1801_1900.P1872_Stone_Game_VIII;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.stoneGameVIII(stones1)); // 5

        int[] stones2 = {7, -6, 5, 10, 5, -2, -6};
        System.out.println(solution.stoneGameVIII(stones2)); // 13

        int[] stones3 = {-10, -12};
        System.out.println(solution.stoneGameVIII(stones3)); // -22
    }
    ...
    public int stoneGameVIII(int[] stones) {
        ...
        // if only one possible final move remains, taking all stones gives the total sum
        int best = prefix[n - 1];

        // first move must take at least 2 stones, so we only consider prefix[1] ... prefix[n - 2]
        for (int i = n - 2; i >= 1; i--) {
