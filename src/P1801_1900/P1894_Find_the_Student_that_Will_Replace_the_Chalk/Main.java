package P1801_1900.P1894_Find_the_Student_that_Will_Replace_the_Chalk;
...
public class Main {
    public static void main(String[] args) {
        ...
        int[] chalk1 = {5, 1, 5};
        int k1 = 22;
        System.out.println("Example 1 Output: " + solution.chalkReplacer(chalk1, k1));  // Output: 0

        int[] chalk2 = {3, 4, 1, 2};
        int k2 = 25;
        System.out.println("Example 2 Output: " + solution.chalkReplacer(chalk2, k2));  // Output: 1
    }
    ...
    public int chalkReplacer(int[] chalk, int k) {
        ...
        // Step 2: Reduce k by the full rounds
        k %= totalChalk;
...
// with the student number 0, then the student number 1, and so on until the teacher reaches the student
...
// if the current number of chalk pieces is strictly less than chalk[i], then the student number i will be asked
