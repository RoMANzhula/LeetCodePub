package P3801_3900.P3838_Weighted_Word_Mapping;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.mapWordWeights(words1, weights1)); // rij
        ...
        System.out.println(solution.mapWordWeights(words2, weights2)); // yyy
        ...
        System.out.println(solution.mapWordWeights(words3, weights3)); // g
    }
...
//Complexity:
// time - O(total nums of characters)
// space - O(n)
