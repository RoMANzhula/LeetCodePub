package P1_100.P63_Unique_Paths_II;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.uniquePathsWithObstacles(grid1)); // Output: 2
        System.out.println(solution.uniquePathsWithObstacles(grid2)); // Output: 1
    }
