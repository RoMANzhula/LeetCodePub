package P101_200.P174_Dungeon_Game;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.calculateMinimumHP(dungeon1)); // 7
        System.out.println(solution.calculateMinimumHP(dungeon2)); // 1
    }
...
// consists of m x n rooms laid out in a 2D grid. Our valiant knight was initially positioned in the top-left
