package P101_200.PFind_Minimum_in_Rotated_Sorted_Array;
...
public class Main {
    ...
    public int findMin(int[] nums) {
        ...
        while (left < right) {
            ...
            if (nums[middle] > nums[right]) left = middle + 1; // min is in the right half
            else right = middle; // min is at middle or in the left half
        }
