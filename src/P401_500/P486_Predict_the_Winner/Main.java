package P401_500.P486_Predict_the_Winner;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] nums1 = {1, 5, 2};
        System.out.println(solution.predictTheWinner(nums1)); // false

        int[] nums2 = {1, 5, 233, 7};
        System.out.println(solution.predictTheWinner(nums2)); // true
    }
...
// each turn, the player takes one of the numbers from either end of the array (i.e., nums[0] or
