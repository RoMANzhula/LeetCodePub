package P3601_3700.P3653_XOR_After_Range_Multiplication_Queries_I;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.xorAfterQueries(nums1, queries1)); // output: 4

        int[] nums2 = {2, 3, 1, 5, 4};
        int[][] queries2 = {{1, 4, 2, 3}, {0, 2, 1, 2}};
        System.out.println(solution.xorAfterQueries(nums2, queries2)); // output: 31
    }
