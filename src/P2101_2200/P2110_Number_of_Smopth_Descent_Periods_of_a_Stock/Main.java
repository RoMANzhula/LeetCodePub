package P2101_2200.P2110_Number_of_Smopth_Descent_Periods_of_a_Stock;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.getDescentPeriods(prices1)); // 7
        System.out.println(solution.getDescentPeriods(prices2)); // 4
        System.out.println(solution.getDescentPeriods(prices3)); // 1
    }

    public long getDescentPeriods(int[] prices) {
        long result = 1;   // first day
        long count = 1;    // current smooth descent length
