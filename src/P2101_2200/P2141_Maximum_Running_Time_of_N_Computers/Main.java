package P2101_2200.P2141_Maximum_Running_Time_of_N_Computers;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int n1 = 2;
        int[] b1 = {3, 3, 3};
        System.out.println(solution.maxRunTime(n1, b1)); // Output: 4

        int n2 = 2;
        int[] b2 = {1, 1, 1, 1};
        System.out.println(solution.maxRunTime(n2, b2)); // Output: 2
    }
    ...
    public long maxRunTime(int n, int[] batteries) {
        ...
        right /= n; // upper bound: average energy per computer
...
//Complexity:
// time - O(m log S)     m = number of batteries, S = total battery sum
// space - O(1)
...
//After two minutes, remove battery 1 from the second computer and insert battery 2 instead. Note that battery 1 can
// still run for one minute.
