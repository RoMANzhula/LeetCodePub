package P2101_2200.P2130_Maximum_Twin_Sum_of_a_Linked_List;
    ...
    public static void main(String[] args) {
        ...
        ListNode head1 = new ListNode(5,
                new ListNode(4,
                        new ListNode(2,
                                new ListNode(1))));
        System.out.println(solution.pairSum(head1)); // 6
        ...
        ListNode head2 = new ListNode(4,
                new ListNode(2,
                        new ListNode(2,
                                new ListNode(3))));
        System.out.println(solution.pairSum(head2)); // 7

        // [1,100000]
        ListNode head3 = new ListNode(1,
                new ListNode(100000));
        System.out.println(solution.pairSum(head3)); // 100001
    }
