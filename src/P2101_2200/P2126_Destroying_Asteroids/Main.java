package P2101_2200.P2126_Destroying_Asteroids;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.asteroidsDestroyed(mass1, asteroids1)); // true

        int mass2 = 5;
        int[] asteroids2 = {4, 9, 23, 4};

        System.out.println(solution.asteroidsDestroyed(mass2, asteroids2)); // false
    }
