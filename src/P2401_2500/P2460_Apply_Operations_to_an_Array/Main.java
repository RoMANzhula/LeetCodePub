package P2401_2500.P2460_Apply_Operations_to_an_Array;
...
//Explanation
//First loop: Merges adjacent equal numbers by doubling the first one and setting the second to 0.
//Second loop: Moves all non-zero elements to the left.
//Remaining elements are automatically set to 0 because result is initialized with zeros.
//Time Complexity: O(n)
