package P3501_3600.P3562_Maximum_Profit_from_Trading_Stocks_with_Discounts;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s.maxProfit(
                2,
                new int[]{3,4},
                new int[]{5,8},
                new int[][]{{1,2}},
    ...
    private Result dfs(int u) {
        ...
        for (int v : g[u]) {
            Result child = dfs(v);
            int[] subDp0 = child.dp0;
            int[] subDp1 = child.dp1;
            int vSize = child.size;
...
//You are given an integer n, representing the number of employees in a company. Each employee is assigned a
// unique ID from 1 to n, and employee 1 is the CEO. You are given two 1-based integer arrays, present and future,
...
//You cannot use any profit earned from future stock prices to fund additional investments and must buy only
// from budget.
...
//Employee 1 and Employee 3 buy their stocks at a total cost of 4 + 4 = 8 <= budget. Thus, the maximum total profit
// achieved is 3 + 7 = 10.
