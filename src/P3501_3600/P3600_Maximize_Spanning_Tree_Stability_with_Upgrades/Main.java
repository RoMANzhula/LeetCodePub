package P3501_3600.P3600_Maximize_Spanning_Tree_Stability_with_Upgrades;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.maxStability(n1, edges1, k1)); // 2
        ...
        System.out.println(solution.maxStability(n2, edges2, k2)); // 6
        ...
        System.out.println(solution.maxStability(n3, edges3, k3)); // -1
    }
...
//Output: -1
//Explanation:
//All edges are mandatory and form a cycle, which violates the spanning tree property of acyclicity. Thus,
// the answer is -1.
