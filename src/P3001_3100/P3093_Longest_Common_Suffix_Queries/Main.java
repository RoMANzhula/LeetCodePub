package P3001_3100.P3093_Longest_Common_Suffix_Queries;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(
                solution.stringIndices(wordsContainer1, wordsQuery1)
        ));
        ...
        System.out.println(Arrays.toString(
                solution.stringIndices(wordsContainer2, wordsQuery2)
        ));
    }
    ...
    private void updateBest(TrieNode node, int index) {
        ...
        if (candidate.length() < currentBest.length()) {
            node.bestIndex = index;
        } else if (candidate.length() == currentBest.length()
...
//For wordsQuery[1] = "bcd", strings from wordsContainer that share the longest common suffix "bcd" are at
// indices 0, 1, and 2. Among these, the answer is the string at index 1 because it has the shortest length of 3.
//For wordsQuery[2] = "xyz", there is no string from wordsContainer that shares a common suffix. Hence the longest
// common suffix is "", that is shared with strings at index 0, 1, and 2. Among these, the answer is the string at
...
//Explanation:
//Let's look at each wordsQuery[i] separately:
//For wordsQuery[0] = "gh", strings from wordsContainer that share the longest common suffix "gh" are at indices 0, 1,
// and 2. Among these, the answer is the string at index 2 because it has the shortest length of 6.
//For wordsQuery[1] = "acbfgh", only the string at index 0 shares the longest common suffix "fgh". Hence it is the
// answer, even though the string at index 2 is shorter.
//For wordsQuery[2] = "acbfegh", strings from wordsContainer that share the longest common suffix "gh" are at
// indices 0, 1, and 2. Among these, the answer is the string at index 2 because it has the shortest length of 6.
