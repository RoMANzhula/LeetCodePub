package P701_800.P788_Rotated_Digits;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Input: " + n1 + " → Output: " + solution.rotatedDigits(n1)); // 4
        System.out.println("Input: " + n2 + " → output: " + solution.rotatedDigits(n2)); // 0
        System.out.println("Input: " + n3 + " → Output: " + solution.rotatedDigits(n3)); // 1
    }
