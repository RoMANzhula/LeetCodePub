package P701_800.P762_Prime_Number_of_Set_Bits_in_Binary_Representation;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.countPrimeSetBits(6, 10));  // 4
        System.out.println(solution.countPrimeSetBits(10, 15)); // 5
    }
