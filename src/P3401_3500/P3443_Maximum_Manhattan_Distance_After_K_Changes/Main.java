package P3401_3500.P3443_Maximum_Manhattan_Distance_After_K_Changes;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String s1 = "NWSE";
        int k1 = 1;
        System.out.println(solution.maxDistance(s1, k1)); // Output: 3

        String s2 = "NSWWEW";
        int k2 = 3;
        System.out.println(solution.maxDistance(s2, k2)); // Output: 6
    }
    ...
    private int flip(String s, int k, String direction) {
        ...
        for (char c : s.toCharArray()) {
            if (direction.indexOf(c) != -1) { // c is in "direction" string
                pos++;
            } else {
                pos--;
                opposite++;
