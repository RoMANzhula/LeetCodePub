package P601_700.P657_Robot_Return_to_Origin;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.judgeCircle("URDL")); // true
    }
...
// once, 'L' will always make it move left, etc. Also, assume that the magnitude of the robot's movement is the same
// for each move.
