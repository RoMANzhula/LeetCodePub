package P901_1000.P955_Delete_Columns_to_Make_Sorted_II;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.minDeletionSize(strs1)); // Expected: 1
        System.out.println(solution.minDeletionSize(strs2)); // Expected: 0
        System.out.println(solution.minDeletionSize(strs3)); // Expected: 3
    }
...
// lexicographic order (i.e., strs[0] <= strs[1] <= strs[2] <= ... <= strs[n - 1]). Return the minimum possible value
// of answer.length.
