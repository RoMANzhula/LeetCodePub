package P901_1000.P944_Delete_Columns_to_Make_Sorted;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.minDeletionSize(new String[]{"cba", "daf", "ghi"})); // 1
        System.out.println(solution.minDeletionSize(new String[]{"a", "b"}));           // 0
