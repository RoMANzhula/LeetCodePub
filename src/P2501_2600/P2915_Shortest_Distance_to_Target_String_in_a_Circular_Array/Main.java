package P2501_2600.P2915_Shortest_Distance_to_Target_String_in_a_Circular_Array;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.closestTarget(words1, "hello", 1)); // Output: 1

        String[] words2 = {"a","b","leetcode"};
        System.out.println(solution.closestTarget(words2, "leetcode", 0)); // Output: 1

        String[] words3 = {"i","eat","leetcode"};
        System.out.println(solution.closestTarget(words3, "ate", 0)); // Output: -1
    }
