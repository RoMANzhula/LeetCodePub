package P1401_1500.P1406_Stone_Game_III;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.stoneGameIII(new int[]{1, 2, 3, -9}));
        System.out.println(solution.stoneGameIII(new int[]{1, 2, 3, 6}));
        System.out.println(solution.stoneGameIII(new int[]{1, 2, 3, -1, -2, -3, 7}));
    }
...
//If Alice chooses one pile her score will be 1 and the next move Bob's score becomes 5. In the next move, Alice will
// take the pile with value = -9 and lose.
//If Alice chooses two piles her score will be 3 and the next move Bob's score becomes 3. In the next move, Alice will
// take the pile with value = -9 and also lose.
