package P2301_2400.P2366_Minimum_Replacements_to_Sort_the_Array;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] nums1 = {3, 9, 3};
        System.out.println(solution.minimumReplacement(nums1));  // Output: 2

        int[] nums2 = {1, 2, 3, 4, 5};
        System.out.println(solution.minimumReplacement(nums2));  // Output: 0
    }
